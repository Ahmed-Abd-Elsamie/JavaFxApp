...
if (isset($_POST['device_num'])&& isset($_POST['customer_name']) && isset($_POST['phone_num']) && isset($_POST['prob'])
    ...
    $sql = "INSERT INTO hardware_fix (device_num, customer_name, phone_num, prob, win7, win8, win10, check_all, hardware, software, battery, charger, bag, cd, other, date_time, device_name, state) " . "VALUES ("
            . "". $device_num .","
            . "'$customer_name',"
            . "". $phone_number .","
            . "'$prob',"
